from PySide6.QtWidgets import QDialog, QVBoxLayout, QGroupBox, QRadioButton, QDialogButtonBox, QApplication, QMessageBox, QComboBox, QPushButton, QHBoxLayout, QSpinBox, QLabel, QSlider
from PySide6.QtCore import QTranslator, QCoreApplication, QEvent, Qt
...
class SettingsDialog(QDialog):
        ...
        if app:
            ...
            if selected_lang == "zh_CN":
                ...
                if self.translator.load(f":/translations/{selected_lang}.qm"):
                    ...
                    print(f"设置对话框：加载英文翻译")
                else:
                    print(f"设置对话框：无法加载英文翻译")
    ...
    def _update_texts(self):
        ...
        if hasattr(self, 'lang_combo'):
            ...
            current_data = self.lang_combo.currentData() if current_index >= 0 else None
        ...
        if hasattr(self, 'options_font_label'):
            self.options_font_label.setText(self.texts["options_font_size"][current_lang])
