...
from PySide6.QtWidgets import (
    ...
    QPushButton, QGroupBox, QMessageBox, QToolTip
)
from PySide6.QtCore import Qt, QObject, QEvent # Added QObject and QEvent
...
class ManageCannedResponsesDialog(QDialog):
    ...
    def __init__(self, parent: QObject = None): # parent should be QWidget for dialogs
        ...
        self.setWindowModality(Qt.WindowModality.ApplicationModal) # Ensures it blocks parent window
    ...
    def _create_ui(self):
        ...
        description_label.setText(self.tr("管理您的常用反馈短语。点击列表项进行编辑，编辑完成后点击更新按钮。"))
        ...
        self.input_field.returnPressed.connect(self._add_or_update_response) # Add/Update on Enter
        ...
        self.delete_button.setObjectName("secondary_button") # Could have a more destructive style
        ...
        self.close_dialog_button.clicked.connect(self.accept) # accept() closes dialog and signals acceptance
    ...
    def _add_new_response(self):
        ...
        self.input_field.clear()
        self.responses_list_widget.setCurrentRow(self.responses_list_widget.count() - 1) # Select new item
        self._update_button_states()
    ...
    def _delete_selected_response(self):
        ...
        current_row = self.responses_list_widget.currentRow() # More reliable than currentItem sometimes
        if current_row >= 0:
    ...
    def retranslateUi(self):
        ...
        if edit_group:
            ...
            if input_field:
                input_field.setPlaceholderText(self.tr("输入新的常用语或编辑选中的项目"))
            ...
            for button in buttons:
                ...
                elif button.objectName() == "clear_all_button" or "清空" in button.text():
